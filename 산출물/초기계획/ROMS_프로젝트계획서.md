# ROMS (Runner-league Overwatch Management System) 프로젝트 계획서
...
### 1.1 프로젝트 개요
**ROMS (Runner-league Overwatch Management System)**는 오버워치 e스포츠 대회(러너리그 시즌 1~4 및 라이벌 클래시 등)의 경기 기록, 대진표, 선수(스트리머) 전적, 맵/영웅 통계 데이터를 체계적으로 수집·관리가 가능하도록 구축하는 **통합 e스포츠 아카이브 및 대시보드 시스템**입니다.
